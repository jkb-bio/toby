...
function openSocial(type) {
  ...
  switch (type) {
    case 'twitter':
      url = 'https://www.roblox.com/users/2866761903/profile';
      break;

      case 'discord':
        url = 'https://www.discord.com/users/1005730789692018700';
        break;  
  }
...
function typerStartTyping(typer) {
  ...
  let text = ['MY SECOND CHRISTMAS KILLED HIMSELF! 🤬', 'MY SECOND CHRISTMAS KILLED HIMSELF! 🤬'];
